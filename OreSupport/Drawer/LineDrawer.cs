...
public partial class Drawer
{
  ...
  public static GameObject DrawBox(string tag, MonoBehaviour parent, float width, Vector3 center, Vector3 extents)
  {
    return DrawBox(tag, parent.gameObject, width, center, extents);
  }
  ///<summary>Creates a renderer with a vertical line (relative to the object).</summary>
  public static GameObject DrawBox(string tag, GameObject parent, float width, Vector3 center, Vector3 extents)
  {
